...
The 2014 St. Patrick’s Day NYC Parade is one of the Top 10 largest parades that have ever happened in New York City, so let's take a look at the types of issues that happened on March 17, 2014.
...
The 2014 St. Patrick’s Day NYC Parade took place in Manhattan (`NEW YORK` country), so we restrict our attention to issues that were reported in New York. As shown in the table above, `Noise - Residential` is the most common `complaint_type` on that day. This makes sense, since the parade was loud and has lasted for a along time. 
