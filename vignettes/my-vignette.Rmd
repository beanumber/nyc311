...
### Database
The `etl` function has three variables -- `object`, `dir`, and `db`. For more information about how to use the `etl` function, please read [etl doucumentation](https://github.com/beanumber/etl/blob/master/README.Rmd).
